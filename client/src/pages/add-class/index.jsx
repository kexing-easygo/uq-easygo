...
import { AtFab, AtModalAction, AtModalContent, AtModalHeader, AtIcon, AtModal } from 'taro-ui'
export default function AddClass() {
    ...
    const handleConfirm = () => {
        ...
        // display the autoAdd assignments Notifier
        setShowModal(true); 
    }
    ...
    return (
        <View>
            ...
            <AtModal isOpened={showModal} onclose={() => setShowModal(false)}>
                <AtModalHeader>建议：</AtModalHeader>
                <AtModalContent>您已成功添加课程，是否需要一并添加该课程的作业至“倒计时”？您可以随后在倒计时页面查看。</AtModalContent>
                <AtModalAction>
                    <AtButton
                        full
                        circle
                        ...
                        onClick={
                            () => {
                                ...
                                setShowModal(false);
                                //Taro.navigateBack();
                                Taro.navigateTo({ url: '/pages/autoadd/index?from=timetable'});
                            }
                        }
                    >
                        好的
