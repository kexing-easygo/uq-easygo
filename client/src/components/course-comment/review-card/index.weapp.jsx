...
export default function ReviewCard(props) {
  ...
  const [bgColor, setBgColor] = useState("#d0d3ff");
  ...
  return (
    <View>
    {(review.checked == "pass" || (review.checked != "pass"  && selfOpenId == openid)) && 
    <>
    <View className='cards' 
      ...
      <View style={type=='double-review-page' ? {marginTop:'12px'}:{marginTop:'10px'}} >
        ...
        className={type=='double-review-page' ? 'review-card shadow': 'review-card'} >
          <View className='review-background' onClick={() => {handleClick()}} style={{ backgroundColor: bgColor }}>
